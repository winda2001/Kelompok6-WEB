...
include 'koneksi.php';
    ...
    $kategori = mysqli_query($conn, "SELECT * FROM tb_produk WHERE category_id = '".$_GET['kat']."' ");
...
<?php
    if(mysqli_num_rows($kategori) > 0){
            ...
            <a href="detail_produk.php?id=<?php echo $k['produk_id'] ?>">
                <img width="100%" src="produk/<?php echo $k['produk_image'] ?>">
                <p class="nama"><?php echo $k['produk_name'] ?></p>
                <p class="harga">Rp. <?php echo $k['produk_price'] ?></p>
                </a>
            </div>
            <?php }}?>
    </div>
